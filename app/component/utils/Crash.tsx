...
export default function Crash({ message }: { message: string }) {
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4">
        ...
        >
          ...
          <div className="rounded-xl border border-red-500/30 bg-red-500/5 p-4 text-center">
            <p
              className="text-sm text-red-400 md:text-base"
          ...
          {}
          <div className="w-24 h-px mx-auto bg-gradient-to-r from-transparent via-primary/50 to-transparent my-2" />
          ...
          {}
          <p
            className="text-xs text-text-gray/50 pt-2"
